...
| [工程与交付规范](https://github.com/laby-ai/.github/blob/main/ENGINEERING_STANDARDS.md) | 防止屎山代码、面向用户交付、工程标准化、Git 协作和测试检查。 |
...
| 项目 | 状态 | 说明 |
| --- | --- | --- |
| [stoneai-admin-web](https://github.com/laby-ai/stoneai-admin-web) | Private | 账号管理前端，对齐管理端交互和权限边界。 |
| [stoneai-studio-web](https://github.com/laby-ai/stoneai-studio-web) | Private | 官网与共享 Studio Web 壳。 |
| [stoneai-ai-python](https://github.com/laby-ai/stoneai-ai-python) | Private | Python AI 服务、计费客户端和集成工具。 |
| [stoneai-admin-backend](https://github.com/laby-ai/stoneai-admin-backend) | Private | 账号、租户成员、权限、计费、支付和审计后端。 |
...
| [sceneweave](https://github.com/laby-ai/sceneweave) | Public | AIGC 短片生产工作流，关注分段视频生成、镜头衔接、音频连续性和可恢复生产。 |
...
- 代码质量、用户体验、工程规范和测试检查参考 [工程与交付规范](https://github.com/laby-ai/.github/blob/main/ENGINEERING_STANDARDS.md)。
